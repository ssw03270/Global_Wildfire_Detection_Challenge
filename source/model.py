...
class SwinTransformer(nn.Module):
    def __init__(self, *, hidden_dim, layers, heads, channels=3, img_size=256, head_dim=32, window_size=7,
        ...
        self.up = nn.ConvTranspose2d(96, 48, kernel_size=2, stride=2)
        self.conv = nn.Conv2d(in_channels=48, out_channels=1, kernel_size=3, stride=1, padding=1)
